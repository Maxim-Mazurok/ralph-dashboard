...
- Live streaming of the active worker, reviewer, or retrospective log with automatic phase rollover, ANSI terminal colors, and nested subagent reasoning and tool timelines
